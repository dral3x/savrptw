...
public class VRPTWBenchmark {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		VRPTWProblem r1_problems[] = {
									...
									new VRPTWProblem("R102", 200), new VRPTWProblem("R103", 200),
									new VRPTWProblem("R104", 200), new VRPTWProblem("R105", 200),
									new VRPTWProblem("R106", 200), new VRPTWProblem("R107", 200),
									new VRPTWProblem("R108", 200), new VRPTWProblem("R109", 200),
									new VRPTWProblem("R110", 200), new VRPTWProblem("R111", 200),
									new VRPTWProblem("R112", 200)
									};

		VRPTWProblem rc1_problems[] = {
									new VRPTWProblem("RC101", 200),
									new VRPTWProblem("RC102", 200), new VRPTWProblem("RC103", 200),
									new VRPTWProblem("RC104", 200), new VRPTWProblem("RC105", 200),
									new VRPTWProblem("RC106", 200), new VRPTWProblem("RC107", 200),
